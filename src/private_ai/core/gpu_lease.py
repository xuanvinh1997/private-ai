"""VRAM accounting for everything that wants the GPU.

One manager per process, held on ``AppServices``. A second instance would double-count
every reservation, which is why nothing here is constructed anywhere else.
"""
